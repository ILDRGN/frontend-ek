let question_arr = ["1. Americans call them French fries, the British call them chips.","2. Americans call it cotton candy, the British call it candyfloss.", "3. Americans call it a clothespin, the British call it a nipper.",
...
let a1_arr = ["True","True","True","True","True","True","True","True"]
let a2_arr = ["False","False","False","False","False","False","False","False"]
let answer_arr = ["In England, what we in America refer to as chips are called crisps.","Fun fact: In Australia they call cotton candy 'fairy floss'.","The British do have a different name for it, though! They generally call it a clothes peg.","The British will also use bonnet to mean a hat (as we use it).","¯\_(ツ)_/¯","The British also call them flip-flops, but sometimes thongs.","Seems like a mouthful (Do you want more hundreds and thousands on your froyo?), but who am I to criticize!","They call them mints too. 'Jezzies' sort of sounds like something they'd say, though, right? 'Aye, lad, you got a tin of jezzies, don't cha?'"]

let n_right_answer_arr=[1,1,2,1,1,2,1,2];
let n_answer = 7;
let right_answers = 0;
let count = -1;
let count2 = 7;
